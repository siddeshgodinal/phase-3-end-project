...
public class AssignmentDemo1 {
	...
	Logger logger = LogManager.getLogger(AssignmentDemo1.class);
	...
	public void Assignment001Post() {
		...
		File file = new File("C:\\Users\\farha\\eclipse-workspace\\Rest-API\\Phase-3-rest-API\\scr\\main\\resource\\data.json");
